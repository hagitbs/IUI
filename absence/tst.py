...
print('ok') 
sql = 'SELECT * FROM `iucc-learning-and-generalizing.IUI.e1_h3_table` ;'
...
SYSTEM_INSTRUCTION = """
You are an expert in literary and linguistic analysis, specializing in identifying themes of surplus, plus, and abundance.
...
write_to_bigquery(df, 'IUI.absence_analysis_gemini', project_id, credentials)   